...
document.getElementById("ShowNetworkInfo").addEventListener("click", function(){
    ...
    document.getElementById("NetworkInfo").innerHTML = "Connection type: " + states[networkState];
});
